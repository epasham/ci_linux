...
docker tag rabbitmq:3-management cg2-linux-asg/rabbitmq:latest
docker tag cg2-linux-asg/rabbitmq:latest  041444721655.dkr.ecr.us-east-1.amazonaws.com/cg2-linux-asg/rabbitmq:latest
